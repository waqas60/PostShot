...
export default function ToggleTheme() {
  ...
  return (
    <button
      ...
      className="absolute top-5 right-5 z-50 flex cursor-pointer items-center justify-center rounded-full border border-neutral-300 p-1 dark:border-neutral-500"
    >
